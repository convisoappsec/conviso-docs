...
This integration uses the [security scans workflow](../security-scans/conviso-ast) as a docker image for all the execution and communication with Conviso Platform.  
