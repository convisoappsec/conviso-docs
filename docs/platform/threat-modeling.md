...
If you want to better understand how **Project Management** works, start with the [Projects](./projects) overview. For the operational flow inside projects, see [Process](../project-management/process.md). For project status meanings and transitions, see [Workflow Status](../project-management/workflow-status.md).

### Monitoring the implementation of requirements through the Project Management feature​

On this screen, in Projects, you can continuously manage these processes and monitor their progress. By opening the created project, you can understand which stage of the modeling workflow is currently in progress:
...
At this point, the project is in the **To do** phase according to its current status. For project status definitions, see [Workflow Status](../project-management/workflow-status.md).

To indicate that work on the security requirements has started, update the project status to **Running**:
...
After accessing the **Requirements** tab, an overview of all security requirements generated by the platform is shown, based on OWASP ASVS and the identified threats:
...
Update the project status to **Done** so the implementation can move to final security validation:
