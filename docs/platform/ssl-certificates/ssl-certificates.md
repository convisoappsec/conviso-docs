...
keywords: [SSL, TLS, certificates, DV, OV, EV, wildcard, multi-domain, SAN, certificate credits, domain control validation, Conviso Platform]
...
protect a fixed set of *different* domains, choose a **multi-domain** certificate and list them as
