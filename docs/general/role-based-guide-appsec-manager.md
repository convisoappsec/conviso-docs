---
id: role-based-guide-appsec-manager
title: AppSec Manager Guide
sidebar_label: AppSec Manager
---
...
Use the [Dashboard](../platform/dashboard) to follow program indicators, compare trends over time, and prioritize decisions on backlog reduction, SLA recovery, and team focus.

## Management and collaboration tool

- Escalation and follow-up communication: [Notifications Center](../platform/notifications-center)
