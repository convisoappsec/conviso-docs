---
id: role-based-guide-security-manager
title: Security Manager Guide
sidebar_label: Security Manager
---
...
Use the [Dashboard](../platform/dashboard) to monitor executive-level indicators, assess risk posture evolution, and support portfolio-level security decisions with measurable data.

## Management and collaboration tool

- Governance notifications and leadership follow-up: [Notifications Center](../platform/notifications-center)
