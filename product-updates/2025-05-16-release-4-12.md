...
![img](/img/new-analytics-dashboard.gif)
...
Access the [dashboard](/platform/dashboard) to check the updates.
...
![img](/img/estimated-savings-with-secure-code-mentor.gif)
