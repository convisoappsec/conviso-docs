...
title: Release 4.26
date: 2026-08-28
slug: 2026-08-28-release-4-26
authors: [wagner_elias]
tags: ["Release Notes", "Risk insight", "Vuln Intelligence", "AI Secure Code", "Web and API Scan", "AI Pentest", "Developer Experience", "Automations", "Data Ingestion", "Risk-Based Vulnerability Management", "Supply Chain Security", "Security Analysis"]
---
...
- The [Conviso GitHub Sync Task](https://github.com/marketplace/actions/sync-external-scans-with-conviso) is available in GitHub Marketplace to import and synchronize assets from external scanners. Learn more in the [GitHub Actions documentation](https://docs.convisoappsec.com/integrations/github-actions#importing-and-synchronizing-assets-from-external-scanners).
